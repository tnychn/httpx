...
func QueryParamsBinder(req *Request) *ValueBinder {
	return &ValueBinder{
		failFast:  true,
		ValueFunc: req.QueryParam,
		ValuesFunc: func(sourceParam string) []string {
			values, ok := req.QueryParams()[sourceParam]
			if !ok {
				return nil
			}
			return values
...
// FormParamsBinder creates form param binder.
// For all requests, FormParamsBinder parses the raw query from the URL and uses query params as form params.
//
// For POST, PUT, and PATCH requests, it also reads the request body, parses it
// as a form and uses query params as form params. Request body parameters take precedence over URL query
// string values in Request.Form.
//
...
func FormParamsBinder(req *Request) *ValueBinder {
	vb := &ValueBinder{
		failFast: true,
		ValueFunc: func(sourceParam string) string {
			return req.FormValue(sourceParam)
		},
		ErrorFunc: NewBindingError,
	}
	vb.ValuesFunc = func(sourceParam string) []string {
		...
		values, ok := req.Form[sourceParam]
		if !ok {
			return nil
		}
		return values
...
// MustStrings requires parameter values to exist to be bind to slice of string variables.
...
// MustInt64 requires parameter value to exist to be bind to int64 variable.
// Returns error when value does not exist
...
// MustInt32 requires parameter value to exist to be bind to int32 variable.
// Returns error when value does not exist.
...
// MustInt16 requires parameter value to exist to be bind to int16 variable.
// Returns error when value does not exist.
...
// MustInt8 requires parameter value to exist to be bind to int8 variable.
// Returns error when value does not exist.
...
// MustInt requires parameter value to exist to be bind to int variable.
// Returns error when value does not exist.
...
// MustInt64s requires parameter value to exist to be bind to int64 slice variable.
// Returns error when value does not exist.
...
// MustInt32s requires parameter value to exist to be bind to int32 slice variable.
// Returns error when value does not exist.
...
// MustInt16s requires parameter value to exist to be bind to int16 slice variable.
// Returns error when value does not exist.
...
// MustInt8s requires parameter value to exist to be bind to int8 slice variable.
// Returns error when value does not exist.
...
// MustInts requires parameter value to exist to be bind to int slice variable.
// Returns error when value does not exist.
...
// MustUint64 requires parameter value to exist to be bind to uint64 variable.
// Returns error when value does not exist.
...
// MustUint32 requires parameter value to exist to be bind to uint32 variable.
// Returns error when value does not exist.
...
// MustUint16 requires parameter value to exist to be bind to uint16 variable.
// Returns error when value does not exist.
...
// MustUint8 requires parameter value to exist to be bind to uint8 variable.
// Returns error when value does not exist.
...
// MustByte requires parameter value to exist to be bind to byte variable.
// Returns error when value does not exist.
...
// MustUint requires parameter value to exist to be bind to uint variable.
// Returns error when value does not exist.
...
// MustUint64s requires parameter value to exist to be bind to uint64 slice variable.
// Returns error when value does not exist.
...
// MustUint32s requires parameter value to exist to be bind to uint32 slice variable.
// Returns error when value does not exist.
...
// MustUint16s requires parameter value to exist to be bind to uint16 slice variable.
// Returns error when value does not exist.
...
// MustUint8s requires parameter value to exist to be bind to uint8 slice variable.
// Returns error when value does not exist.
...
// MustUints requires parameter value to exist to be bind to uint slice variable.
// Returns error when value does not exist.
...
// MustBool requires parameter value to exist to be bind to bool variable.
// Returns error when value does not exist.
...
// MustBools requires parameter values to exist to be bind to slice of bool variables.
// Returns error when values does not exist.
...
// MustFloat64 requires parameter value to exist to be bind to float64 variable.
// Returns error when value does not exist.
...
// MustFloat32 requires parameter value to exist to be bind to float32 variable.
// Returns error when value does not exist.
...
// MustFloat64s requires parameter values to exist to be bind to slice of float64 variables.
// Returns error when values does not exist.
...
// MustFloat32s requires parameter values to exist to be bind to slice of float32 variables.
// Returns error when values does not exist.
...
// MustTime requires parameter value to exist to be bind to time.Time variable.
// Returns error when value does not exist.
...
// MustTimes requires parameter values to exist to be bind to slice of time.Time variables.
// Returns error when values does not exist.
...
// MustDuration requires parameter value to exist to be bind to time.Duration variable.
// Returns error when value does not exist.
...
// MustDurations requires parameter values to exist to be bind to slice of time.Duration variables.
// Returns error when values does not exist.
